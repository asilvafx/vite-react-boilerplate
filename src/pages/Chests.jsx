...
import { Box, Search, Filter, Trophy, Timer, Users, Coins, ArrowLeft, Plus, User } from 'lucide-react';
import { getUserChests, getAvailableChests } from '../lib/chests';
                    ...
                    <div className="premium-panel p-6 rounded-xl">
                        ...
                        <div className="w-full flex items-center space-x-4 mb-6">
                            ...
                            <div className="m-l-auto">
                                <Link to="/create" className="flex items-center cyber-button">
                                    <Plus className="w-4 h-4 mr-2"/>
                                    <span className="hidden md:block">Create New Chest</span>
                                </Link>
                            </div>
                        ...
                        <div className="space-y-4">
                            {filteredChests.map(chest => (
                                <div key={chest.id}
                                     className="premium-panel p-6 rounded-lg hover:bg-cyan-500/5 transition-colors">
                                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                                        <div className="w-full">
                                            <div className="flex items-center space-x-3 mb-2">
                                                <h3 className="text-xl font-bold neon-text">Chest #{chest.id}</h3>
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-br ${chest.plan.color}`}>
                      {chest.plan.name}
                    </span>
                        ...
                        Completed
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                ...
                                                <div className="premium-panel p-3 rounded-lg">
                                                    ...
                                                    <p className="premium-gradient-text font-medium flex items-center">
                                                        ...
                                                        {Math.floor(chest.plan.price * 0.9)} TOKENS
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            {chest.status === 'completed' && chest.winners && (
                                                <div
                                                    className="mt-4 premium-panel p-4 rounded-lg bg-gradient-to-r from-yellow-500/10 to-amber-500/5">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                                        {chest.winners.map((winner, index) => (
                                                            <div key={index}
                                                                ...
                                                                <span
                                                                    className="font-mono text-gray-300">{winner.address}</span>
                                                                <span
                                                                    className="text-yellow-400">{winner.reward} TOKENS</span>
                                                            </div>
                                                        ))}
                                                    </div>
                                                </div>
                                        ...
                                        <Link
                                            to={`/join/${chest.id}`}
                                            className="cyber-button min-w-[150px] text-center"
                                        >
