...
const Home = () => {
    ...
    return (
        <>
            ...
            <Header />
            {/* Hero Section */}
            <section className="text-center py-20 px-4 bg-overlay">
            ...
            <section className="py-20 px-4 text-center">
                ...
                <form className="mt-8 space-y-4">
                    ...
                    <Button className="px-6 py-3 bg-neon-pink text-white font-bold rounded-lg hover:bg-neon-pink-dark transition duration-300" type="submit">
                        Contact Us
                    </Button>
                </form>
                <div className="mt-8">
