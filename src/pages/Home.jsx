    ...
    return (
      ...
      <span className="text-xs bg-primary-600 rounded-full text-primary px-4 py-1.5 mr-3">
        ...
        Flowbite is out! See what's new
                    ...
                    <div className="px-4 mx-auto text-center max-w-screen-xl lg:px-36">
            ...
            <section className="py-20 px-4">
                ...
                <div className="flex overflow-x-auto space-x-8 mt-8 justify-center">
                    <img alt="Google logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/_ISnBc1msvKXT97txpk_le0C8blkSp3tHOms2y1VwEc.jpg"/>
                    <img alt="Meta logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/POEUgJs4t2OthJ1zFMkr-gOLOK27-CviAsFN8-SzuMQ.jpg"/>
                    <img alt="Ethereum logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/qgrQnkOAIfP31VMD-xrHE5g64bNP3R_WoNMVBLFr0Tc.jpg"/>
                    <img alt="OpenAI logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/EX680EWRafk0lWswhVih3YR8W5Vq0Hr_xvFb9KtXPf8.jpg"/>
                    <img alt="Stripe logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/6YNoDD0ZbQi--OsdX8qFQf0PM7kZBhF0QmTiL7QIFcw.jpg"/>
                    <img alt="PayPal logo" className="h-20"
                         src="https://storage.googleapis.com/a1aa/image/PzJlIJxXcPMxTnUVqUApyxUEvOPH_Th5kV2MBlxhEVQ.jpg"/>
                </div>
            </section>
            ...
            <section className="py-20 px-4 text-center">
                ...
                <form className="mt-8 space-y-4">
                    ...
                    <textarea className="w-full p-3 rounded-lg bg-gray-800 text-white"
                              placeholder="Project Details"></textarea>
                    <Button
                        className="px-6 py-3 bg-neon-pink text-white font-bold rounded-lg hover:bg-neon-pink-dark transition duration-300"
                        type="submit">
                        Contact Us
                    </Button>
                </form>
