        ...
        <>
            <section className="w-full max-w-screen-lg mx-auto mb-10">
                ...
                <div className="flex flex-wrap md:flex-nowrap gap-8 mb-8">
                    ...
                    <div className="w-full md:w-2/3 premium-panel p-4 md:p-8 rounded-xl relative overflow-hidden">
                        <div
                                    ...
                                    <div className="premium-panel p-4 md:p-6 rounded-xl">
                                        <div className="space-y-6">
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-sm text-gray-400">
                                                        Buy POL (Polygon) tokens from exchanges like Binance, Coinbase,
                                                        or
                                                        ByBit.
                                                    </p>
                                            ...
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="space-y-1">
                                                    <p className="text-gray-200 font-medium">Transfer POL to your
                                                        wallet</p>
                                                    <p className="text-sm text-gray-400">
                                                        Send the POL tokens to your CyberChest wallet address on the
                                                        Polygon
                                                        network.
                                                    </p>
                                        ...
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="space-y-2">
                                                <p className="text-sm text-gray-300">
                                                    Important: Only send POL tokens on the Polygon network to this
                                                    address.
                                                </p>
                                                <p className="text-sm text-gray-400">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400 mt-1">
                                        ...
                                        <a href="#" className="text-cyan-400 hover:text-cyan-300 ml-1">contact
                                            support</a>.
                                    </p>
                                </div>
                            </div>
