...
const Header = () => {
    ...
    return (
        <>
            <nav className="bg-white border-gray-200 dark:bg-gray-900 w-full max-w-screen-lg mx-auto mt-4 rounded-lg">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a
                        href="/"
                        className="flex items-center space-x-3 rtl:space-x-reverse"
                    >
                        <img className="mr-3 h-10 w-auto filter invert" src={logo_img} width={100} height={100}
                             alt="Logo"/>
                    </a>
                    <button
