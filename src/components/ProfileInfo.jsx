...
import {Copy, User, ArrowRight, LogOut} from 'lucide-react';
...
const ProfileInfo = () => {
    ...
    <section className="w-full max-w-screen-lg mx-auto mb-10">
        ...
        <div className="flex items-center space-x-3 mb-6">
            ...
            <div className="mt-6 flex flex-wrap md:flex-nowrap items-center gap-4 w-full">
                <Link to="/account"
                      className="cyber-button w-full md:w-2/3 flex items-center justify-between gap-2"
                >
                    Manage Account
                    <ArrowRight className="w-4 h-4"/>
            </Link>
            <Link to="/logout"
                  className="cyber-button !bg-red-600 !text-white w-full md:w-1/3 flex items-center justify-between gap-2"
            >
                Logout
